...
if __name__ == '__main__':
    ...
    for line in lines:
        print(line)
        line=line.split('/')
        zz= pth+line[0]+'/rgb_'+line[1].split()[0]+'.png'
        print(zz)
        parser = argparse.ArgumentParser()
        parser.add_argument("--input", "-i", type=str, default=str(zz))
        parser.add_argument("--output", "-o", type=str, default="output/sample_0007/"+str(cnt)+'/')
        parser.add_argument("--config-file", "-c", type=str, default="configs/front3d_sample.yaml")
        parser.add_argument("--model", "-m", type=str, default="data/panoptic_front3d_v3_0707.pth/model_final.pth")
