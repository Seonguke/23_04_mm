...
def main() -> None:
    ...
    parser.add_argument("--config-file", "-c", type=str, default="configs/front3d_train_3d_copy.yaml")
    parser.add_argument("--output-path", type=str, default="data/panoptic_front3d_v3_0707.pth")
